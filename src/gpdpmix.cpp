...
SEXP GPDPMIX(SEXP Ymat, SEXP Otrend, SEXP Oseas, SEXP o_gp_mod, SEXP o_jitter,
        ...
        SEXP o_ipr)
{
    ...
    colvec Taue_tune((ntune-n_move_M)); /* set of parameters used to tune slice sampling step width */
    ...
    for( k = 0; k < ntune; k++ )
    {
        ...
        {
              auxclusterstep(theta_star, wpm, U_last, Omega_t, Omega_s, y, tau_e, noise, jitter, gp_mod, n_parms, 
                         pos_s, s, num, M, w_star, conc, a, b, ipr_dummy, num_ht);
    ...
    for( k = 0; k < niter; k++ )
    {
        ...
        /* auxclusterstep() will adjust the size of (theta_star, U_last, num) as M changes */
        auxclusterstep(theta_star, wpm, U_last, Omega_t, Omega_s, y, tau_e, noise, jitter, gp_mod, 
                         n_parms, pos_s, s, num, M, w_star, conc, a, b, ipr_dummy, num_ht);
        w_tot       = update_w(wpm, wtau);
